    ...
    return (
        <div className="flex">
            ...
            <div className="flex-1 p-6 ml-64 bg-white">
                ...
                {quizCode ? (
                    <div className="mt-4 p-4 border border-green-400 bg-green-100 text-green-700 rounded-md">
                        <p><strong>Quiz created successfully!</strong></p>
                        <p>Your Quiz Code: <strong className="text-green-900">{quizCode}</strong></p>
                    </div>
                ) : (
                    <form onSubmit={handleSubmit} className="space-y-4 mt-6">
                        {error && <p className="text-red-600">{error}</p>}
                        ...
                        <input 
                            ...
                            onChange={(e) => setTitle(e.target.value)} 
                            placeholder="Quiz Title" 
                            className="border p-4 w-full text-gray-600" 
                            required 
                        />
                        <textarea 
                            value={description} 
                        ...
                        <button type="button" onClick={addQuestion} className="border p-2 rounded-xl bg-green-700 text-white w-full mt-2">Add Question</button>
                        <button type="submit" className="border p-2 w-full bg-blue-500 text-white rounded-xl mt-2" disabled={loading}>
                            {loading ? "Creating..." : "Create Quiz"}
                        </button>
                    </form>
                )}
